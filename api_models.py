...
class Post(BaseModel):
    ...
    title: str = Field(min_length=1, max_length=200, description="Заголовок от 1 до 200 символов")
...
class User(BaseModel):
    ...
    name: str = Field(min_length=2, description="Имя должно содержать минимум 2 символа")
